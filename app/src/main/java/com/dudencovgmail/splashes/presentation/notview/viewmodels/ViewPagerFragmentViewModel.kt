...
import com.dudencovgmail.splashes.presentation.notview.base.AViewPagerFragmentViewModel
import com.dudencovgmail.splashes.repository.remote.Repository

class ViewPagerFragmentViewModel(interactor: UseCases) : AViewPagerFragmentViewModel() {
